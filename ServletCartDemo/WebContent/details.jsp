      ...
      <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td width="70%" valign="top">
             ...
             <div id="cart">
               <img src="images/buy_now.png"><a href="javascript:selflog_show(<%=item.getId()%>)"><img src="images/in_cart.png"></a><a href="<%=request.getContextPath()%>/CartServlet?action=show"><img src="images/view_cart.jpg"/></a>
             </div>
          </td>
          <% 
            }
